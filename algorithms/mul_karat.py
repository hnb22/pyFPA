...
if __name__ == "__main__":   
    # Test 1: Simple case - 3.5 × 2.0 = 7.0
    print("Test 1: 3.5 × 2.0")
    a1 = CustomFloat(3.5, precision=64)
    b1 = CustomFloat(2.0, precision=64)
    result1 = KaratsubaMultiplication.multiply(a1, b1, prec=64)
    expected1 = 3.5 * 2.0
    print(f"Karatsuba: {result1.to_float()} (expected: {expected1})")
    print()
    
    # Test 2: Higher precision
    print("Test 2: 1.123456789 × 2.987654321 (128-bit)")
    a2 = CustomFloat(1.123456789, precision=128)
    b2 = CustomFloat(2.987654321, precision=128)
    result2 = KaratsubaMultiplication.multiply(a2, b2, prec=128)
    expected2 = 1.123456789 * 2.987654321
    print(f"Karatsuba: {result2.to_float()} (expected: {expected2})")
    print()
